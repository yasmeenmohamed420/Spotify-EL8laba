...
{
	uint32 Local_u32Routine=Copy_u32Ticks/65535;
	uint32 Local_u32Fraction=Copy_u32Ticks%65535;
...
uint32  TIM2_u16GetElapsedTime(void)
{
	...
	uint16 Local_u16Cycle=Global2_u32Routine - Global2_u32CopyRoutine;
...
{
	uint32 local_u32RemainingTime=0;
...
{
	uint32 Local_u32ElapsedTime;
	uint16 Local_u16Cycle=Global3_u32Routine - Global3_u32CopyRoutine;
...
{
	uint32 Local_u32ElapsedTime;
	uint16 Local_u16Cycle=Global4_u32Routine - Global4_u32CopyRoutine;
...
/* Synchronous API  Lock Processor For Certain Ticks
   ...
   *polling flag (underflow)
   *Tick=>1us*/
void TIM5_voidSetBusyWait( uint32 Copy_u32Ticks )
{
	uint32 Local_u32Routine=Copy_u32Ticks/65535;
	uint32 Local_u32Fraction=Copy_u32Ticks%65535;
	while(Local_u32Routine--)
...
void TIM5_voidSetIntervalSingle( uint32 Copy_u32Ticks, void (*Copy_ptr)(void) )
{
	/*save CallBack*/
...
void TIM5_voidSetIntervalPeriodic( uint32 Copy_u32Ticks, void (*Copy_ptr)(void) )
{
	/*save CallBack*/
	TIM5_CallBack=Copy_ptr;
	/*Set Mode to Periodic*/
...
uint32  TIM5_u16GetElapsedTime(void)
{
	uint32 Local_u32ElapsedTime;
	uint16 Local_u16Cycle=Global5_u32Routine - Global5_u32CopyRoutine;

	Local_u32ElapsedTime=((TIM5->ARR)-(TIM5->CNT))+(Local_u16Cycle*65535);
	return Local_u32ElapsedTime;
}
uint32  TIM5_u16GetRemainingTime(void)
{
	uint32 local_u32RemainingTime=0;
